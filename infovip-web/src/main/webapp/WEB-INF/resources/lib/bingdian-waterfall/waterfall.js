...
;(function( $, window, document, undefined ) {
    ...
    Waterfall.prototype = {
        ...
        _requestData: function(callback) {
            ...
            $.ajax({
                ...
                success: function(data,textStatus, xhr) {
                    self._handleResponse(data, callback, xhr);
         ...
         * @param {Function} callback
         */
        _handleResponse: function(data, callback, xhr) {
            var self = this,
                options = this.options,
            ...
            if ( !checkImagesLoaded ) {
               ...
               self.options.callbacks.loadingFinished(self.$loading, self.options.state.isBeyondMaxPage, xhr);
            } else {
