 ...
 * @author attila
 */
var RegistrationValidator = easejs.Class('RegistrationValidator').extend(DefaultHTMLFormValidator,{
	
	
	'override virtual __construct' : function(controller) {
		this.__super( controller );
			...
			
			{
				...
				validate : function(o) {
					...
					if ( o.getField(this.field).value == "" ) {
						o.addClass(this.field,'warn-box');
						o.addMsg(this.field,__tr('Invalid name'));
						return false;
					}
					return true;
				}
