...
jQuery(document).ready(function() {
    DependencyLoader
        ...
        .js('js/web/activity/ActivityPostController')
        .js('js/web/activity/ActivityController')
        .js('js/web/activity/ActivityWall')
        .js('js/web/activity/ActivityCommentBox')
        .import(function(args){
        	new UIControllerExecutor(  new ActivityController() ).execute(); 
       },{});
}); 