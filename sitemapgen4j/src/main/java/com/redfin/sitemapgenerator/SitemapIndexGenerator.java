...
public class SitemapIndexGenerator {
	...
	public SitemapIndexGenerator(String baseUrl) throws MalformedURLException {
		this(new Options(new URL(baseUrl)));
	}
	...
	private void writeSiteMap(StringBuilder out) throws IOException {
		out.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"); 
		out.append("<sitemapindex xmlns=\"http://www.sitemaps.org/schemas/sitemap/0.9\">\n");
		for (SitemapIndexUrl url : urls) {
			out.append("  <sitemap>\n");
			out.append("    <loc>");
			out.append(UrlUtils.escapeXml(url.url.toString()));
			out.append("</loc>\n");
