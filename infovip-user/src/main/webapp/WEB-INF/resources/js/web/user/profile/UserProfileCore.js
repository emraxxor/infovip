...
jQuery(document).ready(function() {
    DependencyLoader
        ...
        .js('js/web/user/profile/UserProfileController')
        .js('js/web/user/profile/UserProfileAvatarEditorWindow')
        .import(function(args){
        	new UIControllerExecutor(  new UserProfileController( ) ).execute(); 
       },{});
}); 